                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5 col-md-4 p-0">
                                <div class="room-card-img">
                                    <a href="{{url('/room/detail/' . $item->id )}}">
                            ...
                            <div class="col-lg-7 col-md-8 p-0">
                                <div class="room-card-content">
                                    <h3>
                                        <a href="{{url('/room/detail/' . $item->id)}}">{{$item['type']['name']}}</a>
                                    </h3>
                                    ...
                                    <p>{{$item->short_desc}}</p>
                                    <ul>
                                        <li><i class='bx bx-user'></i>{{$item->total_adult}}</li>
                                        <li><i class='bx bx-expand'></i> {{$item->room_capacity}}ft2</li>
                                    </ul>
