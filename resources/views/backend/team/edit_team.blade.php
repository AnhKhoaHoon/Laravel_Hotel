                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="position-relative input-icon">
                                <input name="name" type="text" class="form-control" id="input42" placeholder="Enter Your Name" value="{{$dataTeam->name}}">
                                <span class="position-absolute top-50 translate-middle-y"><i class='bx bx-user'></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="input43" class="col-sm-3 col-form-label"> Update Position</label>
                        <div class="col-sm-9">
                            <div class="position-relative input-icon">
                                <input name="position" type="text" class="form-control" id="input43" placeholder="Enter Your Position" value="{{$dataTeam->position}}">
                                <span class="position-absolute top-50 translate-middle-y"><i class='bx bx-pin'></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="input45" class="col-sm-3 col-form-label">Update Link Facebook</label>
                        <div class="col-sm-9">
                            <div class="position-relative input-icon">
                                <input name="link_fb" type="text" class="form-control" id="input45" placeholder="Link Password" value="{{$dataTeam->link_fb}}">
