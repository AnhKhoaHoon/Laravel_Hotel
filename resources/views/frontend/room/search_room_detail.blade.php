                ...
                <div class="col-lg-4">
                    <div class="room-details-side">
                        <div class="side-bar-form">
                            ...
                            <form action="{{route('user_booking_store',$room_detail->id)}}" method="post" id="bk_form">
                                @csrf
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <input type="hidden" id="total_adult" value="{{ $room_detail->total_adult }}">
                                    <input type="hidden" id="room_price" value="{{ $room_detail->price }}">
                                    <input type="hidden" id="discount_p" value="{{ $room_detail->discount }}">
                    ...
                    <div class="room-details-article">
                        ...
                        <div class="room-details-title">
                            ...
                            <ul>
                                ...
                                <li>
                                    <b> Basic : ${{ $room_detail->price }}/Night/Room</b>
                                </li>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="services-bar-widget">
                                        ...
                                        <div class="side-bar-list">
                                            <ul>
                                                <li>
                                                    <a href="#"> <b>Capacity : </b> {{ $room_detail->room_capacity }}
                                                        Person <i class='bx bxs-cloud-download'></i></a>
                                                </li>
                                                <li>
                                                    <a href="#"> <b>Size : </b> {{ $room_detail->size }}ft2 <i
                                ...
                                <div class="col-lg-6">
                                    <div class="services-bar-widget">
                                        ...
                                        <div class="side-bar-list">
                                            <ul>
                                                <li>
                                                    <a href="#"> <b>View : </b> {{ $room_detail->view }} <i
                                                            class='bx bxs-cloud-download'></i></a>
                                                </li>
                                                <li>
                                                    <a href="#"> <b>Bad Style : </b> {{ $room_detail->bed_style }}
