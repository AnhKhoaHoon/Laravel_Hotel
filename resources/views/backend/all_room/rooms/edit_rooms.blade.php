...
<div class="card">
    ...
    <form class="row g-3" action="{{ route('update.room',$edit_data->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            ...
            <img id="showImage" src="{{ (!empty($edit_data->image)) ? url('upload/roomimg/'.$edit_data->image) : url('upload/no_image.jpg') }}" alt="Admin" class="bg-primary" width="70" height="50"> 
        </div>
   ...
   <select name="facility_name[]" id="basic_facility_name" class="form-control">
    ...
    <a class="card-title btn btn-primary float-right" onclick="addRoomNo()" id="addRoomNo" >
        ...
        <div class="roomnoHide" id="roomnoHide">
            <form action="{{ route('store.room.no',$edit_data->id) }}" method="post">
                @csrf
