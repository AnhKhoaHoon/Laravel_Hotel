                                    ...
                                    <div class="col-xl-12 mx-auto">
                                        ...
                                        <div class="card">
                                            <div class="card-body p-4">
                                                ...
                                                <form class="row g-3" action="{{ route('update.room', $edit_data->id) }}"
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" name="total_child" class="form-control"
                                                            id="input2" value="{{ $edit_data->total_child }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <img id="showImage"
                                                            src="{{ !empty($edit_data->image) ? url('upload/roomimg/' . $edit_data->image) : url('upload/no_image.jpg') }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="view" id="input7" class="form-select">
                                                            ...
                                                            <option value="Sea View"
                                                                {{ $edit_data->view == 'Sea View' ? 'selected' : '' }}>Sea
                                                                View
                                                            </option>
                                                            <option value="Hill View"
                                                                {{ $edit_data->view == 'Hill View' ? 'selected' : '' }}>
                                                                Hill
                                                                View </option>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea name="short_desc" class="form-control" id="input11" placeholder="Address ..." rows="3">{{ $edit_data->short_desc }}</textarea>
                                                    </div>

                                                    <div class="col-md-12">
                                                        <label for="input11" class="form-label"> Description </label>
                                                        <textarea name="description" class="form-control" id="myeditorinstance">{!! $edit_data->description !!}</textarea>
                                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="roomnoHide" id="roomnoHide">
                                                <form action="{{ route('store.room.no', $edit_data->id) }}"
                                                    method="post">
                                                    @csrf

                                                    <input type="hidden" name="room_type_id" value="{{$edit_data->room_type_id}}">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                            ...
                                            <table class="table mb-0 table-striped" id="roomview">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$item->status}}</td>
                                                        <td>
                                                            <a href="{{route('edit.room.no',$item->id)}}"
                                                                class="btn btn-warning px-3 radius-30">Edit</a>
                                                            <a href="{{route('delete.room.no',$item->id)}}" class="btn btn-warning px-3 radius-30"
                                                                id="delete">Delete</a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
